                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="courier_service" name="courier_service" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                @foreach($couriers as $key => $courier)
                                    <option value="{{ $key }}" @selected(old('courier_service') === (string)$key)>{{ is_array($courier) ? $courier['name'] : $courier }}</option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <x-text-input id="shipment_date" name="shipment_date" type="date" class="mt-1 block w-full"
                                :value="old('shipment_date', now()->toDateString())" required />
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <textarea id="shipper_address" name="shipper_address" rows="2" required
                                    class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('shipper_address') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <textarea id="receiver_address" name="receiver_address" rows="2" required
                                    class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('receiver_address') }}</textarea>
