                    ...
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        @if(file_exists(public_path('images/scs-logo.webp')) || file_exists(public_path('images/scs-logo.png')))
                            <picture>
                                ...
                                @endif
                                <img src="{{ asset(file_exists(public_path('images/scs-logo.png')) ? 'images/scs-logo.png' : 'images/scs-logo.webp') }}" alt="{{ config('app.name') }}" class="block h-9 w-auto max-h-9 object-contain shrink-0" style="max-width: 120px;" />
                            </picture>
                        @else
                            <x-application-logo class="block h-9 w-auto fill-current text-gray-800" />
                        @endif
                        <span class="font-semibold text-gray-800 hidden sm:inline">{{ config('app.name') }}</span>
                    </a>
                </div>
